...
def pantalla2(screen, bg_anim):
    ...
    # BOTON ATRAS
    atras = pygame.image.load("atras.png").convert_alpha()
    atras = pygame.transform.scale(atras, (40, 40))
    # Posicion boton atras
    atras_rect = atras.get_rect(topleft = (30,30))

    # BOTON SIGUIENTE
    siguiente = pygame.image.load("siguiente.png").convert_alpha()
    ...
    tiras = {
        "num_jugadores": pygame.image.load("tira naranja.png").convert_alpha(),
        "sets": pygame.image.load("tira naranja2.png").convert_alpha(),
        "minutos": pygame.image.load("tira naranja3.png").convert_alpha(),
        "nivel_COM": pygame.image.load("tira naranja4.png").convert_alpha(),
        "pos_inicial": pygame.image.load("tira naranja5.png").convert_alpha(),
        "aviones": pygame.image.load("tira naranja6.png").convert_alpha(),
        "Maldiciones": pygame.image.load("tira naranja7.png").convert_alpha(),
        "Bloques_final": pygame.image.load("tira naranja8.png").convert_alpha()
    }
    ...
    izquierda = pygame.image.load("izquierda.png").convert_alpha()
    izquierda = pygame.transform.scale(izquierda, (30, 30))
    derecha = pygame.image.load("derecha.png").convert_alpha()
