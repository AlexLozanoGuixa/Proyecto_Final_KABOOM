...
class BackgroundAnimation:
    def __init__(self, screen_width, screen_height):
        ...
        self.sky = pygame.image.load("cielo.png").convert()
        self.sky = pygame.transform.scale(self.sky, (screen_width, screen_height))

        self.ground = pygame.image.load("ground2.png").convert_alpha()
        ...
        self.cloud1 = pygame.image.load("nube2.png").convert_alpha()
        self.cloud2 = pygame.image.load("nube3.png").convert_alpha()
        ...
        self.zeppelin = pygame.image.load("zeppelin.png").convert_alpha()
...
def background_screen(screen):
    ...
    key_sound = pygame.mixer.Sound("interface.mp3")
